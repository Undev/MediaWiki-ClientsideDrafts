...
$messages['de'] = array(
  ...
  'clientsidedrafts-saveinterval'=> 'Entwürfe werden alle $1 Sekunden gespeichert.',
...
$messages['en'] = array(
  ...
  'clientsidedrafts-autosaved'   => 'Draft autosaved at $1',
  'clientsidedrafts-saveinterval'=> 'Drafts are autosaved every $1 seconds.',
  'clientsidedrafts-trouble'     => 'Original has been changed, $1 load draft $2 or $3 skip it $4? Autosaving disabled until you choose the option.'
);
$messages['ru'] = array(
  'clientsidedrafts-description' => 'Это расширение позволяет сохранять и восстанавливать черновики статей на локальном компьютере с использованием HTML5 localStorage.',
  'clientsidedrafts-required'    => 'Для расширения Clientside Drafts требуется поддержка HTML5 storage и JSON со стороны браузера. Обновите браузер, пожалуйста.',
  'clientsidedrafts-autosaved'   => 'Черновик автоматически сохранен в $1',
  'clientsidedrafts-saveinterval'=> 'Черновик сохраняется каждые $1 секунд.',
...
$messages['zh'] = array(
  ...
  'clientsidedrafts-required'    => '自动保存插件需要HTML5储存和JSON支持，请升级您的浏览器到最新版本',
  'clientsidedrafts-autosaved'   => '草稿保存于 $1',
  'clientsidedrafts-saveinterval'=> '草稿保存每 $1 秒',
  'clientsidedrafts-trouble'     => '原文被更改了 $1 用草稿替换当前文字 $2 还是 $3 保留页面现有内容（并删除草稿） $4？ 自动草稿保存功能已经被停止，直到你选择保留草稿还是保留现有文字后才会恢复工作'
);